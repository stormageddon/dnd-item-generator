...
const origins = ["draconic","dwarven","elven","prehistoric","divine","unholy","abyssal","orcish","undead","goblinoid","ghoulish","dark elven","elemental","giant","infernal","cyclopean","aberrant","nightmarish","astral","ethereal","shadowy","feyish","gnomish","natural","clockwork","druidic","alien"];
const monuments = ['statue','tomb','totem','mausolem','meteorite','obelisk','monolith','altar','fountain','slaughterfield','cairn','temple','geode','podium','pillar','well','throne','ship','tree','doll','barrow','archway','gravestone','ruins','fossil','battlefield','mosaic','sigil'];
